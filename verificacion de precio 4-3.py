...
class Localethereum:
   ...
   def extraccion(self, pagina):
      try:
         ...
         nav = self.navegador.find_elements_by_xpath('//*[@id="root"]/div[2]/div[2]/div/div[2]/div[2]/div/div/div/div[1]/div[1]/div/a/div[2]')[0]
         nav1 = self.navegador.find_elements_by_xpath('//*[@id="root"]/div[2]/div[2]/div/div[2]/div[2]/div/div/div/div[2]/div[1]/div/a/div[2]')[0]
         nav2 = self.navegador.find_elements_by_xpath('//*[@id="root"]/div[2]/div[2]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div/a/div[2]')[0]
...
def actualizar():
   ...
   Localethereum("https://localcryptos.com/Ethereum/Skrill/Buy/Sort:Price",
                 "https://localcryptos.com/Ethereum/PAYEER/Buy/Sort:Price",
                 "https://localcryptos.com/Ethereum/Russia/AdvCash/Buy/Sort:Price",
                 "https://localcryptos.com/Ethereum/Skrill/Sell/Sort:Price",
                 "https://localcryptos.com/Ethereum/PAYEER/Sell/Sort:Price",
                 "https://localcryptos.com/Ethereum/Russia/AdvCash/Sell/Sort:Price")
...
def porcentaje():
   ...
   porciento= (float(campoVentaBTC.get())*100/float(campoCompraBTC.get()))-100
   etiquetaPorcentajeBTC= tk.Label(ventana, text= "")
   etiquetaPorcentajeBTC.grid(row=2,column=6)
   etiquetaPorcentajeBTC= tk.Label(ventana, text= porciento)
   etiquetaPorcentajeBTC.grid(row=2,column=6)
...
etiquetaCompraBTC= tk.Label(ventana, text= "CompraBTC")
etiquetaCompraBTC.grid(row=2,column=1)

etiquetaVentaBTC= tk.Label(ventana, text= "VentaBTC")
etiquetaVentaBTC.grid(row=2,column=3)

etiquetaPorcentajeBTC= tk.Button(ventana, text= "calcular", command= porcentaje)
etiquetaPorcentajeBTC.grid(row=2,column=5)
...
campoCompraBTC= tk.Entry(ventana)
campoCompraBTC.grid(row=2,column=2)

campoVentaBTC= tk.Entry(ventana)
campoVentaBTC.grid(row=2,column=4)
